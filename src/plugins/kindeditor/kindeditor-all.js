...
function _getInitHtml(themesPath, bodyClass, cssPath, cssData, contentFontColor) {
	var arr = [
		(_direction === '' ? '<html>' : '<html dir="' + _direction + '">'),
		'<head><meta charset="utf-8" /><title></title>',
		'<style>',
		'html {margin:0;padding:0;color: ' + contentFontColor +  ';}',
		// 'html {margin:0;padding:0;color:red;}',
...
_extend(KEdit, KWidget, {
	init : function(options) {
		...
		var themesPath = _undef(options.themesPath, ''),
			...
			contentFontColor = options.contentFontColor,
		...
		function ready() {
			...
			doc.write(_getInitHtml(themesPath, bodyClass, cssPath, cssData, contentFontColor));
			doc.close();
