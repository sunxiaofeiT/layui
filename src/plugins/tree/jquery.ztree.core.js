    ...
    var settings = {}, roots = {}, caches = {},
        ...
        view = {
            ...
            makeDOMNodeNameBefore: function (html, setting, node) {
                ...
                html.push("<a id='", node.tId, consts.id.A, "'  nodeId='"+node.id+"' class='level-item ", consts.className.LEVEL, node.level, "' treeNode", consts.id.A, " onclick=\"", (node.click || ''),
            ...
            makeNodeIcoStyle: function (setting, node) {
                ...
                if (!node.isAjaxing) {
                    ...
                    if (icon) icoStyle.push("background:url(", icon, ") 0 0 no-repeat;background-size:100%;background-origin: content-box;padding: 3px;");
